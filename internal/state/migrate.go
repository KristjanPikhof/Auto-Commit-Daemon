...
// validation attempts without backfilling already-applied revisions. New tables are pure
...
// v15 and v16 are additive and deliberately have no data backfill: existing intent
