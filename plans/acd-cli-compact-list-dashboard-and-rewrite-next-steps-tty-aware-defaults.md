...
schema_version: 1
exported_at: 2026-05-27T16:16:39.633Z
status: todo
---
...
In scope:
- acd list: TTY defaults to live watch with compact table (basename REPO, short STATUS, no CLIENTS column).
...
Risks: basename collisions across repos; scripts piping acd list must use non-TTY or --once.
...
| 2 | [\[CLI\] Extend list tests for new defaults and flags](#task-4f352a81-fd1a-4bae-bc24-79fd32c7ffd5) | todo | 2 |
| 3 | [\[Docs\] Update operator docs for list and rewrite flows](#task-6a04eafe-78b4-4a20-a8c6-7be0983e803d) | todo | 3 |
| 4 | [\[CLI\] Add rewrite-commits plan-only Next steps footer](#task-7668298f-0743-4e1b-8501-54185c72db67) | todo | 3 |
| 5 | [\[CLI\] Implement compact and verbose acd list table renderers](#task-7d6a1715-9c5f-43c4-a561-60d335522d39) | todo | 4 |
| 6 | [\[CLI\] Test rewrite-commits Next footer output](#task-c3bf5116-5168-4c45-a4b7-9586135f7409) | todo | 0 |
| 7 | [\[CLI\] Default acd list to watch on TTY with --once guard](#task-c462604e-4ff8-479d-b368-aa1e3b96f5b7) | todo | 3 |
...
- [ ] **Add tests for verbose once and basename** — `ddb770bf-5321-463a-9bd4-2ec93097a3f7` (todo)
  Add cases for --verbose paths, collision suffix, and non-watch once snapshot.
...
- [ ] **Render compact list table columns** — `312f21d8-92b6-4158-9119-5f5d58fa3cc4` (todo)
  Implement renderListTableCompact with short status tokens OK wait blk pause miss stale and compact missing format. Signal: TestList compact assertions pass.
- [ ] **Add repo basename display helper** — `a60b688a-02f2-4b90-835f-6cd20f0b97fd` (todo)
  Add pathBasenameLabel with collision suffix using repo_hash tail when duplicate basenames in one snapshot. Signal: unit test or list test covers two same-name paths.
...
*Exported from Trekoon on 2026-05-27T16:16:39.633Z. This is a snapshot — the database is the source of truth.*
